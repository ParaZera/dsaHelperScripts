...
def fixture_resources_dir() -> Path:
    return Path(__file__).parent / "resources"


@pytest.fixture(name="load_html")
def fixture_load_html(resources_dir: Path):
...
@pytest.fixture(name="load_soup")
def fixture_load_soup(load_html):
